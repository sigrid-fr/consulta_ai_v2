                ...
                child: Container(
                  ...
                  child: Column(
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(height:5.0),
                        Text("Data: "+document['appDate'].toString(), style: TextStyle(color: Colors.grey[700], fontSize: 17.0,fontWeight: FontWeight.w400)),
                        SizedBox(height:5.0),
                        ...
                        SizedBox(height:5.0),
                        Text(document["doc_comment"] ?? "---(Sem Comentários)---",style: TextStyle(color: Colors.grey[700], fontSize: 15.0,fontWeight: FontWeight.w300)),
                        SizedBox(height:20.0),
